...
SyntaxHighlighter.brushes.Cpp = function()
{
	...
	var datatypes =	'char16_t,char32_t,ATOM BOOL BOOLEAN BYTE CHAR COLORREF DWORD DWORDLONG DWORD_PTR ' +
	...
	var keywords =	'@public @property break case catch class const __finally __exception __try ' +
					...
					'__declspec __finally __exception __try __attribute__ __asm__ '  +
					'_Alignas _Alignof _Atomic _Bool _Complex _Generic _Imaginary _Noreturn ' +
					'_Static_assert _Thread_local ' +
					'auto alignof asm break case catch class const constexpr ' +
					'const_cast continue decltype default delete deprecated dllexport dllimport do dynamic_cast  ' +
					'else enum explicit export extern false for friend goto if inline ' +
					'mutable naked namespace new noexcept noinline noreturn nothrow nullptr operator  ' +
					'private protected public register restrict reinterpret_cast return selectany ' +
					'signed sizeof static static_assert static_cast struct switch template this ' +
					'thread thread_local throw true try typedef typeid typename union unsigned ' +
					'using uuid virtual void volatile wchar_t while ' ;
